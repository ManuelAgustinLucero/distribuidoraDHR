...
class ClienteController extends Controller
{
     ...
     * Finds and displays a cliente entity.
     *
     * @Route("/clienteVentas/{id}", name="admin_cliente_clienteVentas")
     * @Method("GET")
     */
    public function clienteVentasction($id)
    {
        $em = $this->getDoctrine()->getManager();

        $ventas = $em->getRepository('AppBundle:Venta')->findBy( ['cliente' =>$id]);

        return $this->render('cliente/showVentas.html.twig', array(
            'ventas' => $ventas,
        ));
    }
